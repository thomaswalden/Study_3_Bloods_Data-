...
```{r}
write.csv(main_df,"C:\\Users\\thoma\\OneDrive - Murdoch University\\Desktop\\PhD 2022\\Publications\\Study 2 - Bloods\\Main_Data_Frame (23-08-2022).csv",row.names = FALSE)
```
